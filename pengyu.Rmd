...
plot(log(train_data$total.sulfur.dioxide), (train_data$free.sulfur.dioxide), main = "Kernel Smoothing", xlab = "Logged Total Sulfur Dioxide", ylab = "Free Sulfur Dioxide", pch = 1)
lines(normal_kernel_model$x, normal_kernel_model$y, col = "red", lwd = 2)
lines(box_kernel_model$x, box_kernel_model$y, col = "blue", lwd = 2)
legend("topleft", 
       legend = c("Normal Kernel", "Box Kernel"),
       col = c("red", "blue"),
       lty = 1,
       lwd = 2,
       bty = "n")
...
plot(log(test_data$total.sulfur.dioxide), (test_data$free.sulfur.dioxide), main = "Kernel Smoothing(model line on test_data)", xlab = "Logged Total Sulfur Dioxide", ylab = "Free Sulfur Dioxide", pch = 1)
lines(normal_kernel_model$x, normal_kernel_model$y, col = "red", lwd = 2)
lines(box_kernel_model$x, box_kernel_model$y, col = "blue", lwd = 2)
legend("topleft", 
       legend = c("Normal Kernel", "Box Kernel"),
